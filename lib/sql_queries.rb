...
"SELECT category, name from projects INNER JOIN pledges on projects.id = pledges.project_id INNER JOIN users on pledges.user_id = user.id  where category = 'music';"
end
